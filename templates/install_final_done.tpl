		...
		<li>
			...
			<ul>
				...
				<li>
					...
					<br />We urge you to look at your <kbd>config/config_inc.php</kbd> file. It has various useful settings for sites in production. One of these is the <strong>IS_LIVE</strong> parameter. Setting this to <strong>TRUE</strong> will prevent any visible bug reports and will therefore not display sensitive information to the user.
				</li>
			</ul>
		</li>
		<li>
			...
			<ul>
				...
				<li>Please also have a look at your <kbd>config/config_inc.php</kbd> file. It contains various settings that cannot be set elsewhere and which might be of interest to you.</li>
			</ul>
		</li>
	</ul>
