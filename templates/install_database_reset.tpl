...
{form legend="Your database connection information"}
	...
	<div class="row">
		<p>Your database information is stored in the file <kbd>{$smarty.const.BIT_ROOT_PATH}config/config_inc.php</kbd>. To reset these settings with new ones, delete the settings stored therein before you connect to a different database.</p>
