...
function create_config( $pParamHash ) {
	...
	$config_file = empty( $_SERVER['CONFIG_INC'] ) ? '../config/config_inc.php' : $_SERVER['CONFIG_INC'];
...
//\$gPreScan = array( 'kernel', 'config', 'storage', 'liberty', 'lcconfig', 'themes', 'users', 'switchboard', 'libertygraph');
